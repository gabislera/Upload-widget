...
export function UploadWidgetUploadItem({
  ...
  return (
    ...
    >
      ...
      >
        <Progress.Indicator
          className="bg-indigo-500 h-1 transition-all group-data-[status=success]:bg-green-400 group-data-[status=error]:bg-red-400 group-data-[status=canceled]:bg-yellow-400"
          style={{
